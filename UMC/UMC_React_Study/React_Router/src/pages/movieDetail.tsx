          ...
          <div className="mt-4 w-180">
            ...
            <div className="mt-5">
              <div>
                ...
                <div>
                  <nav className="flex justify-items-center bg-red-500 rounded-md gap-4 w-[220px] divide-x-2 text-white text-center">
                    <li className="flex-1 list-none">
                      <button
                        onClick={(): void =>
                          setView(view === "info" ? view : "info")
                        }
                  ...
                  {view === "cast" && <div className="p-2">"{}"</div>}
                </div>
              </div>
            </div>
          </div>
